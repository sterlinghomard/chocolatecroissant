...
function MyApp({ Component, pageProps }) {
  return (
    <div id='bork' className='bg-amber-100 min-w-screen min-h-screen text-slate-600 flex flex-col items-center py-4 md:py-8 px-5 space-y-4 text-lg sm:text-xl font-jsans relative -z-20'>
      <Component {...pageProps} />
      <Footer />
      
      <svg className='absolute -z-10 top-100 invisible opacity-50 lg:visible left-0 sm:left-20 sm:h-3/4' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg className='absolute -z-10 invisible opacity-50 lg:visible top-0 right-80 h-3/5' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg
        className='absolute -z-10 invisible opacity-50 lg:visible bottom-0 right-40 h-1/2' 
